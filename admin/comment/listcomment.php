...
<body>
  <div class="container-products" style="height:auto">
    <div class="head">
      <h2>Bình luận</h2>
      <a href="index.php?act=addproduct" style="margin-left: -20px; display: none;"><button>Thêm sản phẩm</button></a>
    </div>
    <?php
        require './global.php';
        if(isset($_GET['act'])){
    ...
    <div class="container-content">
      ...
      <div class="list-products">
        <table>
          ...
          <?php
            $sql = "SELECT comment.id, comment.name as tenkh, product.name, comment.text, vote_star.star,  comment.comment_date, product.image
                    FROM comment 
                    JOIN product ON product.id=comment.id_product 
                    JOIN vote_star ON vote_star.id_comment=comment.id
            ...
            foreach ($res as $comment) {
              ...
              echo '<tr class="hover-products" style="text-align: center;">
                    ...
                    <td>'.$name.'</td>
                    <td>'.$text.'</td>
                    <td>'.$star.'<i style="margin-left:5px; color: gold" class="bx bxs-star"></i></td>
                    <td>'.$comment_date.'</td>
                    <td class="dots">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                        class="bi bi-three-dots-vertical " viewBox="0 0 16 16">
                      ...
                      <div style="position:relative">
                        <nav class="manage" style="height: 46px">
                          <a href="index.php?act=delproduct&id">
                            <li>
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-trash" viewBox="0 0 16 16">
                                <path
                          ...
                          <a style="display: none"  href="index.php?act=editproduct&id">
                            <li>
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-pencil-square" viewBox="0 0 16 16">
                                <path
