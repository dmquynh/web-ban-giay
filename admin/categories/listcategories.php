...
<body>
  <div class="container-products">
    <div class="head">
      <h2>Danh mục</h2>
      <a href="index.php?act=addcategories"><button style="left: 695px; position: relative;">Thêm mới danh
          mục</button></a>
    </div>
    <?php
        require './global.php';
    ...
    <div class="container-content">
      <div class="search-filter">
        <form action="" method="post">
          <input type="text" name="keyword" id="" placeholder="Tìm kiếm danh mục">
        </form>
      ...
      <div class="list-products" style="position:relative; top:0px;">
        <table>
          ...
          <?php
            $sql = "SELECT category.id, category.category_name, COUNT(category.category_name) as quantity, category.image, category.status, product.id_category 
            ...
            foreach ($res as $list_cate) {
              ...
              if($status == 1){
                ...
                $status = "<span style='color: #962b1d; background: #de9187; padding: 2px 5px 2px 5px; border-radius: 5px'>Không đăng</span>";
              }
              echo '<tr class="hover-products" style="text-align: center;">
                      <td><input type="checkbox" name="" id=""></td>
                      <td style="padding: 10px"><img src="'.$image.'" alt="" width="82px" height="82px"></td>
                      <td>'.$category_name.'</td>
                      <td>'.$quantity.'</td>
                      <td>'.$status.'</td>
                      <td class="dots">
